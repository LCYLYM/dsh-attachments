...
const required=['installAndBoot','ordinaryFileSend','nativeImagePassThrough','folderConversation','folderSidebarOriginal','existingHostDirectory','foreignReferencePreservation','failureRetry','nativeOSDirectoryDrop','uninstallNoCorePatch'];
