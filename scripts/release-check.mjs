...
const report={version:'0.3.0-rc.4',publicReleaseReady:!failures.length,reason:failures,scope:'manual native-runtime release gate; not a cryptographic attestation'};
