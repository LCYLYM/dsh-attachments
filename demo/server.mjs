...
const mime={'.html':'text/html; charset=utf-8','.js':'text/javascript; charset=utf-8','.mjs':'text/javascript; charset=utf-8','.css':'text/css; charset=utf-8','.jpg':'image/jpeg','.png':'image/png','.gif':'image/gif','.svg':'image/svg+xml','.json':'application/json'};
const server=http.createServer(async(req,res)=>{
  ...
  if(!/^(demo\/|lib\/|src\/|assets\/|docs\/assets\/)/.test(name)||name.includes('..')||name.includes('\\')){res.writeHead(404);res.end();return;}
